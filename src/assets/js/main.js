    ...
    s.on("scroll", function () {
      ...
      e <= 50
        ? (o("header").removeClass("scrollHeader").addClass("fixedHeader"),
          a.attr("src", "./uploads/logo.jpeg"))
        : (o("header").removeClass("fixedHeader").addClass("scrollHeader"),
          a.attr("src", "./uploads/logo.jpeg")),
        t.attr("src", "./uploads/logo.jpeg");
    }),
    s.on("scroll", function () {
    ...
    o(document).ready(function () {
      o(".testimonial-carousel").owlCarousel({
        ...
        o(".slider-fade2").owlCarousel({
          ...
          animateIn: "fadeIn",
          animateOut: "fadeOut",
          responsive: { 0: { items: 1 }, 576: { items: 1, dots: !0 } },
        }),
        ...
        o(".slider-fade").on("changed.owl.carousel", function (e) {
          ...
          o(".title").removeClass("animated fadeInUp"),
            ...
            o(".price").removeClass("animated fadeInUp"),
        ...
        o(".slider-fade2").on("changed.owl.carousel", function (e) {
          e = e.item.index - 2;
          o(".banner-line-shape").removeClass("animated fadeInLeft"),
            o(".slider-circle-shape").removeClass("animated fadeInUp"),
            ...
            o(".owl-item")
              .not(".cloned")
              .eq(e)
              .find(".banner-line-shape")
              .addClass("animated fadeInLeft"),
            o(".owl-item")
              .not(".cloned")
              .eq(e)
              .find(".slider-circle-shape")
              .addClass("animated fadeInUp"),
            o(".owl-item")
              .not(".cloned")
              .eq(e)
